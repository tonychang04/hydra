...
| 4 | revalidate RED to GREEN regression test is green | `bash scripts/test-revalidate-contract.sh` | exit 0 / "test-revalidate-contract: OK" | PASS | ran it -> exit 0; "test-revalidate-contract: OK (19 passed)" |
